...
import mainVisualImage from "../images/pages/index/main-visual.jpg"
import aboutEyecatchImage from "../images/pages/index/about-eyecatch.jpg"
import servicesEyecatchImage from "../images/pages/index/services-eyecatch.jpg"
...
<section className={mainVisual}>
  <img className={mainVisualImg} src={mainVisualImage} alt="Main visual" />
...
<article className={article}>
  ...
  <section className={section}>
    ...
    <div className={sectionContainer}>
      ...
      <div className={sectionRight}>
        <img className={sectionImg} src={aboutEyecatchImage} alt="About eyecatch" />
      </div>
    </div>
  </section>
  ...
  <section className={section}>
    ...
    <div className={sectionContainer}>
      ...
      <div className={sectionRight}>
        <img className={sectionImg} src={servicesEyecatchImage} alt="About eyecatch" />
      </div>
    </div>
  </section>
